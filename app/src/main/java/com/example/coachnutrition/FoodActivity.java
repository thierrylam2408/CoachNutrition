                    ...
                    builder.setSingleChoiceItems(choices, -1, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (choices[which] == "modifier") {
                                ...
                                checkedChoices[delete] = false;
                                checkedChoices[detail] = false;
                            } else if (choices[which] == "supprimer") {
                                checkedChoices[which] = true;
                                checkedChoices[alter] = false;
                                checkedChoices[detail] = false;
                    ...
                    builder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (checkedChoices[alter]) {
                                if (!display.getDetail()) {
                                    Toast.makeText(getApplicationContext(), "Il faut activer le detail", Toast.LENGTH_LONG).show();
                                } else {
